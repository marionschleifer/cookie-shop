...
/* package haskookie-0.1.0.0 */
#ifndef VERSION_haskookie
#define VERSION_haskookie "0.1.0.0"
#endif /* VERSION_haskookie */
#ifndef MIN_VERSION_haskookie
#define MIN_VERSION_haskookie(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskookie */
...
#define CURRENT_COMPONENT_ID "haskookie-0.1.0.0-inplace-haskookie"
